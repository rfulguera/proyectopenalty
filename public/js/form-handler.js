  ...
  function submitButtonHandler (evt) {
     var testForm = document.getElementById('testForm');
      ...
      $.ajax({
        ...
        type: 'POST',
        data: {
          nom: testForm.nom.value,
          ape: testForm.ape.value,
          dir: testForm.dir.value,
          corr: testForm.corr.value,
          tel: testForm.tel.value,
          usu: testForm.usu.value,
          pas: testForm.pas.value,
        },
